...
const CreateCompanyService = async (companyData) => {
    const { name, phone, email, status, planId, campaignsEnabled, dueDate, recurrence, password } = companyData;
    ...
    const passwordHash = await (0, bcryptjs_1.hash)(password || "123456", 8);
