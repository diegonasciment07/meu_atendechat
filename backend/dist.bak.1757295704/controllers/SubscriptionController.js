...
const createSubscription = async (req, res) => {
    ...
    if (!(await schema.isValid(req.body))) {
        throw new AppError_1.default("Validation fails 1", 400);
    }
    ...
    try {
        ...
        throw new AppError_1.default("Validation fails 2", 400);
    }
};
...
const createWebhook = async (req, res) => {
    ...
    if (!(await schema.isValid(req.body))) {
        throw new AppError_1.default("Validation fails 3", 400);
    }
